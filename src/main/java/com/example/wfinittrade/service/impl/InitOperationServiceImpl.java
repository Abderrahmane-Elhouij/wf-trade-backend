...
public class InitOperationServiceImpl implements InitOperationService {
    ...
    public long getTotalOperations() {
        return initOperationRepository.count();
    }

    @Override
    public BigDecimal getTotalAmountMAD() {
        return initOperationRepository.getTotalContreValeurMad();
    }

    @Override
    public long getDraftCount() {
        return initOperationRepository.countByOperationDraftTrue();
    }

    @Override
    public long getPendingDecisionCount() {
        return initOperationRepository.countByDecisionFinalIsNull();
    }

    @Override
    public long getUniqueClientsCount() {
        return initOperationRepository.countDistinctDonneurOrdre();
    }

    @Override
    public BigDecimal getMaxClientBalance() {
        return initOperationRepository.findMaxSoldeComptable();
    }

    @Override
    public long getVipClientsCount() {
        return initOperationRepository.countByDonneurOrdreVipTrue();
    }

    @Override
    public long getMissingBICCount() {
        return initOperationRepository.countByBeneficiaireBanqueBicIsNull();
    }

    @Override
    public long getExpiredOperationsCount() {
        return initOperationRepository.countExpiredValidite(LocalDate.now());
    }

    @Override
    public long getCancelledOpsCount() {
        return initOperationRepository.countByMotifCancelIsNotNull();
    }

    @Override
    public long getAmendedOpsCount() {
        return initOperationRepository.countByMotifAmendIsNotNull();
    }

    @Override
    public long getWorkflowAttachedCount() {
        return initOperationRepository.countByProcessInstanceIdIsNotNull();
    }

    @Override
    public long getAwaitingDecisionCount() {
        return initOperationRepository.countByDecisionFinalIn(Arrays.asList("Awaiting Decision", "Pending"));
    }

    @Override
    public long getCompletedCount() {
        return initOperationRepository.countByDecisionFinalIn(Arrays.asList("Completed", "Finished"));
    }

    @Override
    public List<InitOperation> getOperationsBetween(LocalDate start, LocalDate end) {
        return initOperationRepository.findByOperationCreationDateBetween(start, end);
    }
